            ...
            async on_click_send_wp_direct(event) {
                ...
                if (partner.mobile) {
                    ...
                    message +=
                        ...
                        " amounting in " +
                        "*" +
                        this.env.pos.format_currency(receipt.total_with_tax) +
                        "* " + 
                        " from " +
                    ...
                    if (receipt.orderlines.length > 0) {
                        ...
                        _.each(receipt.orderlines, function (orderline) {
                            message += "%0A" + "*" + orderline.product_name + "*" + "%0A" + "*Qty:* " + orderline.quantity + "%0A" + "*Price:* " + self.env.pos.format_currency(orderline.price) +  "%0A";
                    ...
                    message += "*" + "Total Amount:" + "*" + "%20" + self.env.pos.format_currency(receipt.total_with_tax) ;
