...
dict_theme_style = {
    ...
    "style_3":  {
        ...
        "style_4":  {
        # "primary_color": "#7978e9",
        # "secondary_color": "#f0f0f0",
        # "gradient_color": "#eea799",
...
class sh_pos_theme_settings(models.Model):
    ...
    def write(self, vals):
        ...
        for rec in self:
            ...
            URL = "/sh_pos_all_in_one_retail/static/sh_pos_theme_responsive/static/src/scss/pos_theme_variables.scss"
            ...
            content = """     
                ...
                $sh_pos_gradient_color: %(gradient_color)s;
