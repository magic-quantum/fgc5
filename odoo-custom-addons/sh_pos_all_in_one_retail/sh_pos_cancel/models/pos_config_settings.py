...
class ResCompany(models.Model):
    ...
    pos_operation_type = fields.Selection([('cancel_draft', 'Cancel and Reset to Draft'), ('cancel_delete', 'Cancel and Delete'), ('cancel', 'Cancel'), ('paid', 'Paid')], string="Opration Type", default="cancel_draft")
