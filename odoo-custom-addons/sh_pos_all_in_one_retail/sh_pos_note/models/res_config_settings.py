...
class ResConfigSettiongsInhert(models.TransientModel):
    ...
    pos_enable_internal_note = fields.Boolean(related="pos_config_id.enable_internal_note", readonly=False)
    pos_enable_screen_note = fields.Boolean(related="pos_config_id.enable_screen_note", readonly=False)
    ...
    pos_enable_customer_note = fields.Boolean(related="pos_config_id.enable_customer_note", readonly=False)
